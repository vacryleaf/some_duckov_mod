...
public class MicroWormholeGenerator : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("生成程序化图标", GUILayout.Height(30)))
        {
    ...
    private void SaveAsPrefab()
    {
        ...
        Debug.Log($"[微型虫洞] Prefab 已保存到: {path}");
    ...
    /// 生成程序化图标
    /// </summary>
    private void GenerateProceduralIcon()
    {
        int size = 256;
