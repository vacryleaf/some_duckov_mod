...
/// <summary>
/// AssetBundle 构建工具
/// 用于将名刀月影的 Prefab 打包为 AssetBundle
/// </summary>
public class AssetBundleBuilder
{
    ...
    // AssetBundle 名称
    private static string bundleName = "moonlight_sword";
    ...
    {
        // 武器 Prefab
        SetBundleName("Assets/Prefabs/MoonlightSword.prefab");
    ...
    /// 清理 AssetBundle 名称
    /// </summary>
    [MenuItem("Tools/名刀月影/清理 AssetBundle 名称")]
    ...
    /// 一键部署到 Mod 目录
    /// </summary>
    [MenuItem("Tools/名刀月影/部署到 Mod 目录")]
